...
$config['stage_file_proxy_origin'] = 'https://' . $site_path;
...
// Prevent Kint from loading too much debug output and crashing the response.
...
// Use devel mail system from local.
